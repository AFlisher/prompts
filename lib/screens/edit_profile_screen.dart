  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (profile != null) {
        ...
        _bioController.text =
            (profile.bio ?? '').trim().isNotEmpty ? profile.bio! : _defaultBio;
      }
    });
  }
                ...
                children: [
                  ...
                  const Center(
                    child: Text(
                      'Tap to change photo',
                      style:
                          TextStyle(color: AppTheme.mediumGray, fontSize: 12),
                    ),
                  ),
                  const SizedBox(height: 36),
          ...
          Row(
            children: [
              Icon(Icons.mail_outline_rounded,
                  color: AppTheme.mediumGray.withValues(alpha: 0.6), size: 18),
              const SizedBox(width: 10),
              Text(
                displayEmail,
                style: TextStyle(
              ...
              Icon(Icons.lock_outline_rounded,
                  color: AppTheme.mediumGray.withValues(alpha: 0.4), size: 16),
            ],
          ),
        ],
      ),
